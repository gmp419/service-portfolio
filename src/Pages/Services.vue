    ...
    >
      ...
      <div class="group rounded px-8 py-12 shadow hover:bg-primary">
        ...
        <div class="text-center">
          ...
          <p class="text-grey pt-4 text-sm group-hover:text-white md:text-base">
            Building custom Software as a Service (SaaS) solutions that streamline your business processes and boost efficiency.
          </p>
        </div>
      </div>
      <div class="group rounded px-8 py-12 shadow hover:bg-primary">
        ...
        <div class="text-center">
          ...
          <p class="text-grey pt-4 text-sm group-hover:text-white md:text-base">
            Creating sleek and responsive mobile applications to connect with your audience on the go.
          </p>
        </div>
      </div>
      <div class="group rounded px-8 py-12 shadow hover:bg-primary">
        ...
        <div class="text-center">
          ...
          <p class="text-grey pt-4 text-sm group-hover:text-white md:text-base">
            Harness the power of email campaigns to engage, nurture, and convert your audience.
          </p>
        </div>
      </div>
      <div class="group rounded px-8 py-12 shadow hover:bg-primary">
        ...
        <div class="text-center">
          ...
          <p class="text-grey pt-4 text-sm group-hover:text-white md:text-base">
            Seamlessly deploying your applications to ensure they're accessible and functional for your users.
          </p>
        </div>
      </div>
      <div class="group rounded px-8 py-12 shadow hover:bg-primary">
        ...
        <div class="text-center">
          ...
          <p class="text-grey pt-4 text-sm group-hover:text-white md:text-base">
            Reviving and modernizing outdated software systems, ensuring they remain secure, efficient, and compatible with current technology.
          </p>
        </div>
      </div>
    </div>
